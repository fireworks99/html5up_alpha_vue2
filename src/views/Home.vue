		...
		<div id="page-wrapper">
				...
				<nav id="nav">
					<ul>
						...
						<li>
							...
							<ul>
								<li><router-link to="/contact">ContactMobile</router-link></li>
								<li><router-link to="/generic">GenericMobile</router-link></li>
								<li><router-link to="/elements">ElementsMobile</router-link></li>
								<li>
									<a href="#">Submenu</a>
									<ul>
			...
			<section id="banner">
				...
				<ul class="actions special">
					<li><a href="/" class="button primary">登录</a></li>
...
export default {
  ...
  async mounted() {
    const jsFiles = [
		require('@/assets/js/main.js').default // 使用 require 来引入 JS 文件
      // 添加其他 JS 文件的路径
    ];
